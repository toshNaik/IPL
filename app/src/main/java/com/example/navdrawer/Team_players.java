...
public class Team_players extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(Team_players.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        progressDialog = new ProgressDialog(Team_players.this);
        progressDialog.setMessage("Loading Products");

        list = new ArrayList<>();

        adapter = new row_adapter(Team_players.this, list);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(displayName[0]).child("CSK").child("Players");
